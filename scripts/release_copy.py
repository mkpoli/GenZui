"""Descriptions of the released forms, independent of design-review notes."""
...
FORM_DESCRIPTIONS = {
    ...
    0x2A708: 'TOMO places a MO stem and return beside TO. Both components have a shared optical reduction, with space between their upper entries.',
    0x2CF00: 'SHITE connects an enlarged SHI dot to a NO-derived descent.',
    0x2CEFF: 'Katakana NARI combines a native SHI entry with a drawn lower curve. Printed historical forms guide its structure.',
    0x2CF02: 'Hiragana NARI has an opening diagonal and a rounded lower wave. Noto E supplies the terminal shape.',
}
