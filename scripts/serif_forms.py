...
def refinements(part, transform, bold=False):
    ...
    forms = {
        ...
        0x1B124: [stem, transform(part('キ', [0]), (1, 0, .075, 1, 60, 0)), drawn(
            ...
            'M202.3 515.3 C381.4 547 553 591 694 632.4 '
            'C731 643.7 755 656 783 659 '
            'C820.6 661 864.6 653 881 617 '
            'C893.7 582 862 556 831.4 552.6 '
            'C696.4 531 461.4 470.3 209.7 434 Z'), drawn(
            ...
            'M203.3 280 C396.4 322 599 362 786 423 '
            'C812 431 834 443 862.3 443.6 C901 444 942 434 958 400 '
            'C970.6 365.3 937.5 340.3 908.4 339 '
            'C691.4 322.6 474.5 250.3 210 196 Z')],
        ...
        0x1B125: [stem, move(part('テ', [2]), 80),
            ...
            'M202 479 C397 496 612 516 758 539 '
            'C802 548 822 560 850 561.6 '
            'C892 560 934.5 543 956.4 514 '
            'C975.6 489 967.3 444.7 929 438 '
            'C893 433.3 864.3 445.4 814 444.7 '
            'C638.5 458 441.4 415.3 208 391.4 Z')],
        ...
        0x1B126: [drawn(
            ...
            'M96 684 L133.3 699 C177 657 179 660 190 656 '
            'C247.7 653 368 661 419.7 678.4 '
            'C428 679.5 435.3 693 466 696.5 '
            'C507 691.5 552.7 662 571.7 625 '
            'C578.7 584.5 553 574.3 556 566.7 '
            'C541.6 456 539.7 279.7 524.5 88 L428.4 91.3 '
            'C425.5 279.5 444 464.3 444 600 '
            'C439 600.3 462 577.6 455 587 '
            'C375 591 287.3 574 222 557 '
            'C206.3 553.4 200.7 544.5 174 542 '
            'C125 548.3 100.4 592.7 92.7 629 Z'), drawn(
            ...
            'M115.7 426.3 L152 447 '
            'C202.5 403.4 201 408.4 209.5 404.7 '
            'C288 402 360 420 506.3 423 L506 336.3 '
            'C361.4 326 305.7 314.3 237 298 '
            'C223.4 295 210.3 287 188 286.3 '
            'C138.7 292 116.3 339.6 112 378 Z'), drawn(
            ...
            'M84 172.5 L119 192.4 C169 147.6 168.7 154 181.7 149.4 '
            'C247.7 147 382 164 453.5 174 '
            'C491 174.4 530.3 162 543.5 126 '
            'C553 96 527.7 64 495 65 C469.5 65.7 447 72 420.4 74 '
            'C344.7 75.6 266 59.7 218 45.5 '
            'C203 42 191.7 34 168 32.6 C119.4 38 89 84.4 84 123 Z'),
        ...
        0x2A708: [stem, move(reshape(part('モ', [2]), tomo_entry_point), 90, 82),
            ...
            'M201 407.4 C430 424 637 446.7 788 476 '
            'C815.6 481 830.5 489.5 856 489 '
            'C894 486.3 938.6 469 957 436 '
            'C975.7 403 946 367 915 368.7 '
            'C877 367.5 849.7 376 821 376 '
            'C628.3 386.6 425.6 338.3 206 320.3 Z')],
