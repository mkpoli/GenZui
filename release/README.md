...
First public release of GenZui Serif / 源萃明朝, a Japanese Mincho derived from
Noto Serif JP, Noto Serif Hentaigana and FRB Taiwanese Kana.

The font contains 17,052 encoded characters, including 286 hentaigana, seven
...
`releases/v0.111/` contains the immutable font assets. Preserve all versioned
